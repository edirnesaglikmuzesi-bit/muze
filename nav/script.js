...
const TRANSLATIONS = {
  ...
  fr:{
   ...
   ru:{
    ...
    intro_title:'Приглашение к Порогу',
    intro_sub:'Путешествие сквозь время — к центру исцеления…',
    back:'← НАЗАД',
    menu_lang:'Язык: Русский 🇷🇺',
    menu_map:'Карта и местоположение',
    menu_defter:'Мост Сердца',
    loc_searching:'📍 Определение местоположения…',
    loc_outside:'📍 Вы находитесь вне территории Кюллие.',
    loc_error:'📍 Не удалось определить местоположение. Пожалуйста, включите доступ к геолокации.',
    gb_name:'Ваше имя',
    gb_city:'Ваш город',
    gb_msg:'Оставьте здесь свои чувства…',
    gb_submit:'Я ДОБАВЛЯЮ СВОЙ КАМЕНЬ В МОСТ 🪨',
    gb_submitting:'Запечатывается…',
    gb_conn_err:'Ошибка соединения. Пожалуйста, попробуйте снова.',
    gb_no_msg:'Пожалуйста, оставьте сообщение…',
    confirm_text:'Ваши чувства были запечатаны на Мосту Сердца. След, который вы оставили, обогащает духовное наследие нашего Кюллие…',
    confirm_close:'ПУСТЬ ВЫ ОБРЕТЁТЕ ИСЦЕЛЕНИЕ 🌿',
    latest_title:'📜 Последние сообщения',
    archive_title:'🗂️ Архив',
    no_msg:'Пока нет сообщений. Станьте первым, кто добавит свой камень! ✨',
    s0_main:'🏛️ КЮЛЛИЕ СУЛТАНА БАЯЗИДА II',
    s0_sub:'МУЗЕЙ ЗДОРОВЬЯ',
    s0_slogan:'✨ ПУТЕШЕСТВИЕ ИСЦЕЛЕНИЯ — ВХОД В МУЗЕЙ',
    s1_main:'Вход в Дарюшшифа',
    s1_sub:'🏛️ ВРАТА СПРАВЕДЛИВОСТИ И ИСЦЕЛЕНИЯ',
    s1_slogan:'⚖️ ПЕРВАЯ ОСТАНОВКА ИСЦЕЛЕНИЯ',
    s2_main:'Выход из Зала Презентации',
    s2_sub:'🏛️ ОТ ЗНАНИЙ К ОПЫТУ',
    s2_slogan:'🏛️ АДМИНИСТРАЦИЯ И ПОРЯДОК',
    s3_main:'Большой Лазарет (ВОСЬМИУГОЛЬНЫЙ ЗАЛ)',
    s3_sub:'🏛️ ПОРОГ ДАРЮШШИФА',
    s3_slogan:'🌊 ВЕРШИНА ИСЦЕЛЕНИЯ',
    s4_main:'Медицинская Мадраса',
    s4_sub:'🎓 КОЛЫБЕЛЬ ЗНАНИЙ',
    s4_slogan:'📚 СВЕТ ОБРАЗОВАНИЯ',
    s5_main:'Большой Двор',
    s5_sub:'🌿 ВЕКОВЫЕ ПЛАТАНЫ',
    s5_slogan:'🌳 ВРЕМЯ И СПОКОЙСТВИЕ',
    s6_main:'Имарет (Благотворительная Кухня)',
    s6_sub:'🍲 СОСТРАДАНИЕ И ИЗОБИЛИЕ',
    s6_slogan:'🍲 КУХНЯ ЯХЬЯ БАБЫ',
    s7_main:'Подготовка к Духовной Атмосфере',
    s7_sub:'🕌 ВХОД В МЕЧЕТЬ',
    s7_slogan:'✨ ОДИН КУПОЛ — БЕСКОНЕЧНЫЙ ПОКОЙ',
    s8_main:'Духовное Путешествие Внутри Мечети',
    s8_sub:'🕌 ДВОР МЕЧЕТИ',
    s8_slogan:'🌌 ФИНАЛ ПОД КУПОЛОМ',
    s9_main:'Время Прощаться',
    s9_sub:'🌊 ПРИГЛАШЕНИЕ НА МОСТ СЕРДЦА',
    s9_slogan:'✨ ОСТАВЬТЕ СВОЙ СЛЕД В ЭТОЙ ИСТОРИИ',
    s10_main:'🖋️ Мост Сердца',
    s10_slogan:'"Исцеление прошлого встречается со словами сегодняшнего дня."',
    nav_back:'← НАЗАД',
    s0_ct1:'👑 ИСТОРИЯ',
    s0_ct2:'🏗️ СТРУКТУРА',
    s0_ct3:'🎧 ВАШ ГИД',
    s0_ct4:'📵 ВНИМАНИЕ',
    s0_ct5:'📍 МЕСТОПОЛОЖЕНИЕ',
    s0_ct6:'🏫 ОРИЕНТАЦИЯ',
    s0_c1:'Сейчас вы находитесь в одном из самых впечатляющих исторических мест Эдирне — Музее Здоровья Кюллие Султана Баязида II.',
    s0_c2:'Построенный султаном Баязидом II, сыном Мехмеда Завоевателя и восьмым османским султаном, под руководством главного архитектора Хайреттина, этот комплекс является лучше всего сохранившимся кюллие Османской империи.',
    s0_c3:'Я проведу вас по Кюллие и нашему музею с помощью текстов, аудио и визуальных материалов.',
    s0_c4:'Пожалуйста, не отвлекайтесь от своего телефона во время экскурсии.',
    s0_c5:'Вы прошли билетную кассу и сейчас находитесь в переднем саду.',
    s0_c6:'Справа от вас находится Медицинская Мадраса, а прямо впереди — Дарюшшифа.',
    s0_callout:'👣 <strong>Осмотрев большую фотографию, войдите в сад Дарюшшифы через дверь слева.</strong>',
    s0_fwd:'НАЧАТЬ ПУТЕШЕСТВИЕ ВО ВРЕМЕНИ →',
    s1_ct1:'🏥 ДАРЮШШИФА — 1-Й ДВОР',
    s1_ct2:'🌍 ИСТОРИЧЕСКОЕ ЗНАЧЕНИЕ',
    s1_ct3:'🛏️ СЛУЖЕБНЫЕ ПОМЕЩЕНИЯ',
    s1_ct4:'🩺 ПАЛАТЫ И ОСМОТР',
    s1_ct5:'🧭 НАПРАВЛЕНИЕ',
    s1_ct6:'💧 КОЛОДЕЦ МОЛОКА',
    s1_ct7:'🌿 ДЕРЕВО И ПЛЮЩ',
    s1_ct8:'🎬 ЗАЛ ПРЕЗЕНТАЦИИ',
    s1_c1:'Вы находитесь в первом дворе Дарюшшифы Эдирне — одного из важнейших лечебных центров Османской империи.',
    s1_c2:'Это здание считается одним из первых тщательно спланированных госпиталей в истории.',
    s1_c3:'Четыре комнаты слева от входа использовались как служебные помещения.',
    s1_c4:'Справа находятся шесть комнат для осмотра пациентов.',
    s1_c5:'Оставьте подробный осмотр этих помещений на потом, а сейчас позвольте мне провести вас в зал презентации.',
    s1_c6:'Это каменное сооружение называется «Колодец Молока».',
    s1_c7:'Чуть дальше вы увидите дерево, обвитое плющом.',
    s1_c8:'Сразу после стихотворения слева находится наш зал презентации.',
    s1_callout:'🎬 <strong>Хотите посмотреть презентационный фильм?</strong>',
    s1_watch:'СМОТРЕТЬ ПРЕЗЕНТАЦИЮ ▶',
    s1_fwd:'К ЗАЛУ ПРЕЗЕНТАЦИИ →',
    s2_ct1:'🚪 ВХОД ВО 2-Й ДВОР',
    s2_ct2:'🏛️ АДМИНИСТРАТИВНЫЕ КОМНАТЫ',
    s2_ct3:'🔒 АДМИНИСТРАТИВНЫЙ РАЗДЕЛ',
    s2_ct4:'✨ НАДПИСЬ И ВХОД',
    s2_c1:'Выйдя из зала презентации, пройдите через большую дверь слева.',
    s2_c2:'В этом дворе находятся четыре комнаты, использовавшиеся главным врачом и другими врачами.',
    s2_c3:'Этот административный раздел также служил защитным барьером.',
    s2_c4:'Теперь прочитайте надпись над дверью и затаите дыхание…',
    s2_callout:'🚶‍♂️ <strong>Войдите в это волшебное место, где музыка и звук воды соединяются с исцелением.</strong>',
    s2_fwd:'ОТКРОЙТЕ БОЛЬШОЙ ЛАЗАРЕТ →',
    s3_ct1:'🏥 ЛЕЧЕБНОЕ ОТДЕЛЕНИЕ',
    s3_ct2:'🌊 СТРУКТУРА ГОСПИТАЛЯ',
    s3_ct3:'🎵 МУЗЫКОТЕРАПИЯ',
    s3_ct4:'💧 ВОДНАЯ ТЕРАПИЯ',
    s3_ct5:'🌿 АРОМАТЕРАПИЯ',
    s3_ct6:'🧺 ТРУДОТЕРАПИЯ',
    s3_ct7:'🚶 ВЫХОД И ЭКСКУРСИЯ',
    s3_c1:'Сейчас вы находитесь в самом сердце нашего музея и лечебного отделения Дарюшшифы Эдирне.',
    s3_c2:'Представьте себе госпиталь, где вас встречает ритмичный звук фонтана.',
    s3_c3:'Особенностью этого госпиталя было использование музыкальных ладов в лечении.',
    s3_c4:'Звук воды был важной частью терапии.',
    s3_c5:'Помимо музыки и воды, здесь практиковалась ароматерапия.',
    s3_c6:'Также использовалась трудотерапия.',
    s3_c7:'После осмотра залов вы можете покинуть лечебное отделение.',
    s3_callout:'🏫 <strong>К МЕДИЦИНСКОЙ МАДРАСЕ:</strong> Покиньте Дарюшшифу и направляйтесь к Медицинской Мадрасе.',
    s3_fwd:'К МАДРАСЕ →',
    s10_body:'Мы будем рады услышать, какие впечатления оставило у вас это 500-летнее путешествие.',
