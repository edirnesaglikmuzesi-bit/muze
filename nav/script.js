...
const TRANSLATIONS = {
  ...
  it:{
    ...
    back:'← INDIETRO',menu_lang:'Lingua: Italiano 🇮🇹',menu_map:'Mappa & Posizione',menu_defter:'Ponte del Cuore',
    ...
    gb_name:'Nome e Cognome',gb_city:'La tua Città',gb_msg:'Lascia qui i tuoi sentimenti…',
    gb_submit:'AGGIUNGO ANCHE IO UNA PIETRA AL PONTE 🪨',gb_submitting:'Sigillando…',
    ...
    confirm_close:'CHE TU POSSA GUARIRE 🌿',latest_title:'📜 Messaggi Recenti',archive_title:'🗂️ Archivio',
    no_msg:'Ancora nessun messaggio. Sii il primo ad aggiungere una pietra! ✨',
    s0_main:'🏛️ COMPLESSO DI SULTAN BAYEZID II',s0_sub:'MUSEO DELLA SALUTE',s0_slogan:'✨ VIAGGIO DI GUARIGIONE — INGRESSO MUSEO',
    s1_main:'Ingresso Darüşşifa',s1_sub:'🏛️ PORTA DI GIUSTIZIA E GUARIGIONE',s1_slogan:'⚖️ PRIMA TAPPA DELLA GUARIGIONE',
    s2_main:'Uscita dalla Sala Presentazioni',s2_sub:'🏛️ DALLA CONOSCENZA ALL\'ESPERIENZA',s2_slogan:'🏛️ AMMINISTRAZIONE E ORDINE',
    s3_main:'Grande Ospedale (ALA OTTAGONALE)',s3_sub:'🏛️ SOGLIA DEL DARÜŞŞIFA',s3_slogan:'🌊 LA VETTA DOVE L\'ANIMA GUARISCE',
    s4_main:'Madrasa di Medicina',s4_sub:'🎓 CULLA DELLA SCIENZA',s4_slogan:'📚 LUCE DELLA CONOSCENZA',
    s5_main:'Grande Cortile',s5_sub:'🌿 PLATANI SECOLARI',s5_slogan:'🌳 TEMPO E PACE',
    s6_main:'Imaretto',s6_sub:'🍲 COMPASSIONE E ABBONDANZA',s6_slogan:'🍲 LA CUCINA DI YAHYA BABA',
    s7_main:'Preparazione all\'Atmosfera Spirituale',s7_sub:'🕌 INGRESSO MOSCHEA',s7_slogan:'✨ UNA CUPOLA, PACE INFINITA',
    s8_main:'Viaggio Spirituale all\'Interno della Moschea',s8_sub:'🕌 CORTILE DELLA MOSCHEA',s8_slogan:'🌌 FINALE SOTTO LA CUPOLA',
    s9_main:'Momento dell\'Addio',s9_sub:'🌊 INVITO AL PONTE DEL CUORE',s9_slogan:'✨ LASCIA ANCHE TU IL TUO SEGNO IN QUESTA STORIA',
    s10_main:'🖋️ Ponte del Cuore',s10_slogan:'"La guarigione del passato incontra le parole di oggi."',
    nav_back:'← INDIETRO',
    s0_ct1:'👑 STORIA',s0_ct2:'🏗️ ARCHITETTURA',s0_ct3:'🎧 GUIDA',s0_ct4:'📵 ATTENZIONE',s0_ct5:'📍 POSIZIONE',s0_ct6:'🏫 ORIENTAMENTO',
    s0_c1:'Ti trovi ora in uno dei siti storici più affascinanti di Edirne, il Museo della Salute del Complesso di Sultan Bayezid II. Benvenuto in questo luogo dove storia e guarigione si incontrano.',
    s0_c2:'Questo complesso di edifici fu costruito da Sultan Bayezid II, figlio di Fatih Sultan Mehmet e ottavo sultano ottomano, su progetto dell\'architetto capo Hayrettin. È il complesso ottomano meglio conservato fino ai giorni nostri. Al centro c\'è la moschea, a destra il darüşşifa e la madrasa, a sinistra l\'imaret e il kiler, ai lati della moschea le foresterie e sul retro il ponte sul fiume Tunca.',
    s0_c3:'Per aiutarti a visitare il complesso e il museo in modo più consapevole, cercherò di guidarti con testi, audio e immagini.',
    s0_c4:'Si prega di non distogliere l\'attenzione dal proprio telefono cellulare.',
    s0_c5:'Hai appena superato la biglietteria e ti trovi nel giardino anteriore. Fermati davanti alla grande fotografia del complesso appesa al muro di fronte e osserva la posizione di questo insieme di edifici nella città di Edirne.',
    s0_c6:'Mentre cammini verso questo punto, l\'edificio alla tua destra è la Madrasa di Medicina del complesso, mentre quello di fronte è il Darüşşifa, forse il cuore del complesso e centro del museo.',
    s0_callout:'👣 <strong>Dopo aver visitato la grande fotografia, entrate nel giardino del Darüşşifa dalla porta immediatamente a sinistra.</strong>',
    s0_fwd:'INIZIA IL VIAGGIO NEL TEMPO →',
    s1_ct1:'🏥 1° CORTILE DEL DARÜŞŞIFA',s1_ct2:'🌍 IMPORTANZA STORICA',s1_ct3:'🛏️ SERVIZI OSPEDALIERI',s1_ct4:'🩺 AMBULATORI',s1_ct5:'🧭 ORIENTAMENTO',s1_ct6:'💧 POZZO DEL LATTE',s1_ct7:'🌿 L\'ALBERO E L\'EDERA',s1_ct8:'🎬 SALA PRESENTAZIONI',
    s1_c1:'Ora ti trovi nel primo cortile del Darüşşifa di Edirne, uno dei più importanti centri di guarigione ottomani. Fermati un momento e osserva ciò che ti circonda.',
    s1_c2:'Prima di tutto devi sapere questo: questo edificio è considerato uno dei primi esempi di ospedali con pianta centrale e dettagliata nella storia. Esempi simili in Occidente apparvero solo circa 200 anni dopo.',
    s1_c3:'Proseguendo lungo il percorso, le quattro stanze immediatamente a sinistra dell\'ingresso sono i servizi del Darüşşifa: stanza del personale, lavanderia, cucina dietetica e dispensa.',
    s1_c4:'Alla tua destra, dietro le colonne, si trovano sei ambulatori dove venivano effettuate le visite quotidiane, le cure e gli interventi d\'urgenza.',
    s1_c5:'Lascia la visita dettagliata di queste stanze al ritorno e seguimi ora verso la sala presentazioni, situata più avanti a sinistra nel primo cortile.',
    s1_c6:'Questa struttura in pietra è chiamata "Pozzo del Latte" perché si credeva che la sua acqua aumentasse il latte delle neomamme.',
    s1_c7:'Circa 20 metri oltre, tra l\'erba, vedrai un albero con un\'edera avvolta attorno. Leggete la triste poesia d\'amore di Ahmet Kutsi Tecer su quel pannello.',
    s1_c8:'Subito a sinistra della poesia si trova la sala presentazioni, dove puoi guardare il video sulla storia del complesso e del Darüşşifa.',
    s1_callout:'🎬 <strong>Vuoi guardare la presentazione video? Puoi vederla dentro la sala o sul tuo telefono.</strong>',
    s1_watch:'GUARDA LA PRESENTAZIONE ▶',s1_fwd:'PASSAGGIO AL 2° CORTILE →',
    s2_ct1:'🚪 INGRESSO AL 2° CORTILE',s2_ct2:'🏛️ UFFICI AMMINISTRATIVI',s2_ct3:'🔒 SEZIONE AMMINISTRATIVA',s2_ct4:'✨ ISCRIZIONE E INGRESSO',
    s2_c1:'Non appena esci dalla sala presentazioni, passa attraverso la maestosa porta immediatamente a sinistra ed entra nel secondo cortile con gli uffici dei dirigenti.',
    s2_c2:'In questo cortile ci sono 4 stanze, due per lato. Il medico capo e gli altri medici usavano queste stanze; tutte le attività dell\'ospedale venivano pianificate ed eseguite qui.',
    s2_c3:'Questa sezione con gli uffici amministrativi fungeva anche da barriera protettiva tra la circolazione quotidiana dei pazienti nel primo cortile e il reparto di degenza in cui stai per entrare.',
    s2_c4:'Ora leggi l\'iscrizione dell\'ospedale scritta sopra la porta… e trattieni il respiro…',
    s2_callout:'🚶‍♂️ <strong>Entra in questo luogo magico dove musica e suono dell\'acqua si incontrano con la guarigione.</strong>',
    s2_fwd:'SCOPRI IL GRANDE OSPEDALE →',
    s3_ct1:'🏥 REPARTO DI DEGENZA',s3_ct2:'🌊 STRUTTURA DELL\'OSPEDALE',s3_ct3:'🎵 MUSICOTERAPIA',s3_ct4:'💧 IDROTERAPIA',s3_ct5:'🌿 AROMATERAPIA',s3_ct6:'🧺 ERGOTERAPIA',s3_ct7:'🚶 USCITA E VISITA',
    s3_c1:'Ora ti trovi nel cuore del museo e nel reparto di degenza del Darüşşifa di Edirne. Cammina con i sentimenti di coloro che trovarono guarigione in questo luogo di cura 500 anni fa.',
    s3_c2:'Immagina un ospedale dove al centro scorre una fontana con ritmo costante e di fronte c\'è un palco musicale. Questo ospedale a pianta centrale coperto da un\'ampia cupola è composto da 6 stanze invernali, 4 estive e un palco musicale.',
    s3_c3:'La caratteristica principale che distingueva questo ospedale dagli altri era l\'uso dei maqam musicali nel trattamento. Un gruppo di 10 musicisti eseguiva musica secondo le indicazioni dei medici per ogni malattia.',
    s3_c4:'Il suono dell\'acqua che scorreva dalla fontana al centro dell\'edificio era una parte importante della terapia, volta a tranquillizzare i pazienti.',
    s3_c5:'Oltre alla musica e al suono dell\'acqua, veniva praticata anche l\'aromaterapia. I profumi delle piante coltivate nel cortile del Darüşşifa erano una parte importante della cura.',
    s3_c6:'Anche l\'ergoterapia veniva usata come terapia in questo ospedale. I pazienti venivano impegnati in lavori di cesteria, maglia e vari lavori manuali per distrarli dalle loro preoccupazioni.',
    s3_c7:'Dopo aver visitato le stanze che illustrano i vari aspetti della medicina ottomana, puoi uscire dal reparto di degenza.',
    s3_callout:'🏫 <strong>Verso la Madrasa di Medicina: uscite dal Darüşşifa e dirigetevi alla Madrasa di Medicina sul lato sinistro del giardino d\'ingresso.</strong>',
    s3_fwd:'STRADA VERSO LA MADRASA →',
    s4_ct1:'🏫 MADRASA DI MEDICINA',s4_ct2:'🌍 IMPORTANZA STORICA',s4_ct3:'📚 SISTEMA EDUCATIVO',s4_ct4:'🏛️ STRUTTURA ARCHITETTONICA',s4_ct5:'📜 EVLIYA ÇELEBI',s4_ct6:'👨‍🏫 CORPO DOCENTE',s4_ct7:'📖 MANOSCRITTI',s4_ct8:'🏥 MUSEO DELLA SALUTE',
    s4_c1:'Dopo aver visitato il Darüşşifa, siamo arrivati all\'altra sezione importante del complesso, la Madrasa di Medicina del Complesso di Sultan Bayezid II.',
    s4_c2:'L\'edificio che circonda il cortile quadrato che stai vedendo era una delle istituzioni educative più autorevoli dell\'Impero Ottomano per la formazione dei medici.',
    s4_c3:'Come madrasa del grado più alto nel sistema educativo ottomano, gli studenti potevano approfondire la formazione teorica attraverso la pratica nel Darüşşifa adiacente.',
    s4_c4:'Questa madrasa è composta da 18 stanze per studenti su tre lati e un\'aula frontale.',
    s4_c5:'Evliya Çelebi, che visitò il complesso nel 1652, scrisse: "Nella madrasa di medicina ci sono studenti che discutono costantemente di studiosi come Platone, Socrate, Aristotele e Galeno."',
    s4_c6:'Il corpo docente era composto da un professore che insegnava a 18 studenti con uno stipendio giornaliero di 60 akçe, un assistente, un bibliotecario e 2 domestici.',
    s4_c7:'38 manoscritti medici scritti a mano qui sono sopravvissuti fino ad oggi e sono attualmente conservati nella Biblioteca dei Manoscritti di Selimiye.',
    s4_c8:'La madrasa è stata aperta come seconda sezione del museo della salute dall\'Università di Tracia nel 2007. L\'aula frontale all\'ingresso è la parte più importante.',
    s4_callout:'🚶 <strong>Dopo aver visitato le stanze, uscite dalla madrasa, passate per il tornello e dirigetevi verso il cortile della moschea.</strong>',
    s4_fwd:'VERSO LA MAESTÀ DELLA MOSCHEA →',
    s5_ct1:'🌳 NEL GIARDINO',s5_ct2:'💧 BILANCIA DELL\'ACQUA',s5_ct3:'🕌 PORTALE PRINCIPALE MOSCHEA',s5_ct4:'🏛️ KILER E IMARET',
    s5_c1:'Dopo aver visitato il Darüşşifa e la madrasa, sei entrato nel giardino della moschea. Cammina lentamente attraverso questo bellissimo giardino allineato con platani secolari e dirigiti verso la sezione imaret di fronte.',
    s5_c2:'Entrando nel giardino dal lato Darüşşifa, nell\'angolo della moschea sulla destra troverai una struttura rettangolare in pietra alta circa 4 metri. Questa è la bilancia dell\'acqua del complesso.',
    s5_c3:'Superata la bilancia dell\'acqua, il maestoso portale della moschea vi accoglie sulla destra. Lasciamo l\'esplorazione da quel portale alla fine del tour.',
    s5_c4:'Di fronte ci sono due grandi edifici con architettura simile. Quello a sinistra è il kiler e il forno, quello a destra è l\'imaret che visiteremo ora.',
    s5_callout:'🍲 <strong>Sei pronto a sentire la cultura dell\'imaret ottomano e la leggenda di Yahya Baba?</strong>',
    s5_fwd:'VERSO IL CENTRO DELL\'ABBONDANZA →',
    s6_ct1:'🏛️ IMARETTI',s6_ct2:'🍲 IMARET DI SULTAN BAYEZID II',s6_ct3:'🔥 CUCINA E MENSA',s6_ct4:'🎭 QUESTA SEZIONE DEL MUSEO',s6_ct5:'🌿 MAUSOLEO DI YAHYA BABA',s6_ct6:'📖 LEGGENDA DI YAHYA BABA',s6_ct7:'⚖️ PROVA DEL DISPENSIERE',s6_ct8:'👑 TESTIMONIANZA DEL SULTANO',s6_ct9:'🐟 IL MIRACOLO DEI PESCI',s6_ct10:'🤲 LA FINE DI YAHYA BABA',s6_ct11:'🪦 VISITA AL MAUSOLEO',
    s6_c1:'Nell\'Impero Ottomano, gli imaretti erano una delle istituzioni più importanti che incarnavano lo spirito di solidarietà sociale e compassione. Distribuivano pasti gratuiti a poveri, viaggiatori e studenti.',
    s6_c2:'Ti trovi proprio in uno di questi luoghi. L\'Imaret del Complesso di Sultan Bayezid II è aperto come terza sezione del museo della salute.',
    s6_c3:'Il grande spazio che vedi all\'ingresso è la cucina. La grande sala visibile dalla porta a destra era il luogo dove si mangiava sui tavoli di pietra sul pavimento.',
    s6_c4:'Anche questa sezione è animata con manichini a grandezza naturale che raccontano la cultura degli imaretti ottomani.',
    s6_c5:'Proprio dietro l\'imaret si trova il mausoleo del leggendario Yahya Baba. Ti racconto la leggenda tramandata fino ad oggi.',
    s6_c6:'Secondo la leggenda, Yahya Baba era il capo cuoco durante il regno di Sultan Bayezid II e preparava un riso pilaf squisito. Andava a dare il pilaf avanzato ai pesci del fiume Tunca.',
    s6_c7:'Il dispensiere, vedendolo, iniziò a ridurre la quantità di riso che riceveva ogni giorno. Eppure Yahya Baba continuava a cucinare il pilaf pregando, nutrendo pazienti e pesci.',
    s6_c8:'La voce giunse alle orecchie del Sultano, che si nascose sulla riva del fiume per assistere di persona. "Ehi, stai buttando il cibo dei pazienti nel fiume!" gridò arrabbiato.',
    s6_c9:'Mentre Yahya Baba si paralizzava e si prostrava, i pesci alzarono la testa dall\'acqua e parlarono: "Il grande Sultano invidia il cibo dei pesci?"',
    s6_c10:'Il Sultano capì il suo errore e aspettò che Yahya Baba si rialzasse… ma quest\'uomo virtuoso aveva già lasciato questa vita.',
    s6_c11:'Il mausoleo di Yahya Baba è ancora oggi venerato come luogo sacro visitato da chi passa per pregare.',
    s6_callout:'🪦 <strong>Dopo aver ascoltato questa leggenda, esci dall\'imaret e fai una pausa al bar del museo a sinistra.</strong>',
    s6_fwd:'VERSO IL BAR DEL MUSEO →',
    s7_ct1:'🏛️ CORTILE E INGRESSO MOSCHEA',s7_ct2:'🚪 INGRESSO E ATMOSFERA',s7_ct3:'⛲ FONTANA E QUIETE',s7_ct4:'🏛️ COLONNE DI MARMO',s7_ct5:'✨ PACE INTERIORE',s7_ct6:'👁️ MOMENTI DI OSSERVAZIONE',s7_ct7:'🚪 INGRESSO NELLA MOSCHEA',s7_ct8:'🪵 ARTE KÜNDEKARI',
    s7_c1:'Dopo aver visitato le sezioni del museo della salute e aver gustato uno sherbet al bar, è il momento di incontrare l\'edificio più maestoso del complesso: la moschea.',
    s7_c2:'Entrando dalla porta che dà sul cortile, sarete accolti dall\'arte della lavorazione del marmo. Lasciate il rumore del mondo esterno e entrate in un\'atmosfera completamente diversa.',
    s7_c3:'La fontana al centro del cortile riempie lo spazio con un suono d\'acqua tranquillo, portando pace.',
    s7_c4:'Le colonne di marmo che circondano si ergono come un anello protettivo.',
    s7_c5:'Ciò che si sente qui non è solo la bellezza dell\'architettura. È la pace interiore che non è cambiata per secoli.',
    s7_c6:'Fermati un momento vicino alla fontana e osserva l\'armonia di questo cortile.',
    s7_c7:'Poi rivolgiti verso il maestoso portale di fronte e spingi delicatamente la tenda di pelle che copre la porta per entrare.',
    s7_c8:'All\'ingresso, nota la lavorazione del legno kündekari originale sopra la porta.',
    s7_callout:'🕌 <strong>Entriamo nell\'interno del santuario?</strong>',
    s7_fwd:'PROCEDI VERSO L\'INTERNO →',
    s8_ct1:'🕌 INTERNO MOSCHEA — FINALE',s8_ct2:'🚤 TRASPORTO STORICO E TRADIZIONE REALE',s8_ct3:'👑 IMMAGINARE LA TRIBUNA REALE',s8_ct4:'🏛️ TRIBUNA REALE',s8_ct5:'⚙️ MIHRAB E PIETRE DI EQUILIBRIO',s8_ct6:'🪵 MIMBAR E ARTIGIANATO',s8_ct7:'📐 SIMBOLI E SIGNIFICATI',s8_ct8:'💡 LUCE E ACUSTICA',s8_ct9:'🌌 LA MAESTÀ SOTTO LA CUPOLA',s8_ct10:'🏗️ PUNTO DI SVOLTA ARCHITETTONICO',s8_ct11:'✨ FINALE E ADDIO',
    s8_c1:'Ora ti trovi all\'interno della moschea, il centro del complesso. Concludiamo il tour sotto questa maestosa cupola.',
    s8_c2:'Sultan Bayezid II e i successivi sultani venivano a questa moschea attraversando il fiume Tunca con una barca reale. Entravano dalla porta sulla riva del fiume e pregavano nella tribuna reale.',
    s8_c3:'Chiudi gli occhi… immagina il Sultano che prega in quell\'altezza nella stessa pace di tutti gli altri.',
    s8_c4:'Qui si trova la prima tribuna reale mai realizzata nella storia dell\'architettura islamo-turca. Dirigiamoci ora verso il mihrab.',
    s8_c5:'Tocca le pietre di equilibrio su entrambi i lati del mihrab e ruotale leggermente: ti sorprenderà che le fondamenta di questo grande edificio non siano inclinate nemmeno di un millimetro.',
    s8_c6:'Avvicinandoti al pulpito sulla destra, sarai colpito dalla delicatezza e dall\'eleganza della lavorazione del marmo.',
    s8_c7:'Volgi le spalle al mihrab e guarda sopra la porta d\'ingresso. Il motivo del cocomero simboleggia che c\'è un imaret nel complesso e che i visitatori sono invitati a mangiare.',
    s8_c8:'Le finestre intorno alla cupola garantiscono una luce uniforme in tutto lo spazio. Combinata con la potente acustica della moschea, conferisce profondità allo spazio.',
    s8_c9:'E ora alza lo sguardo… ammira questa maestosa cupola alta circa 31 metri e con un diametro di 22 metri. Un capolavoro architettonico sorretto da quattro pareti senza colonne intermedie.',
    s8_c10:'È considerata anche un importante precursore nella transizione verso le strutture a cupola singola.',
    s8_c11:'Sotto questa cupola incomparabile, concludiamo questo viaggio che ha collegato le orme del passato con la quiete di oggi. Porta con te la pace e la meraviglia che questo luogo ha lasciato nel tuo cuore.',
    s8_callout:'🙏 <strong>Diciamo un silenzioso addio a questo viaggio spirituale?</strong>',
    s8_fwd:'VERSO L\'ADDIO →',
    s9_c1:'🏛️ Passo dopo passo abbiamo seguito le orme del passato e abbiamo respirato vita in questa magnifica architettura. Ora è il momento di aggiungere il tuo stesso respiro a questo luogo storico.',
    s9_c2:'💭 Ciò che risuona nel tuo cuore… un momento di pace, una profonda ammirazione, o una nota silenziosa che rimane nella tua mente…',
    s9_c3:'📖 Il libro degli ospiti preparato per te è l\'archivio spirituale di questa esperienza.',
    s9_c4:'✨ Condividi con noi ciò che trabocca dal tuo cuore e lascia un\'impronta eterna sul Ponte del Cuore…',
    s9_callout:'✍️ <strong>Ti invitiamo a scrivere i tuoi sentimenti nella pagina del Ponte del Cuore.</strong>',
    s9_fwd:'SCRIVI SUL PONTE DEL CUORE →',
    s10_body:'Raccontaci l\'impressione che questo viaggio di 500 anni ha lasciato nel complesso. Le tue parole diventano le pietre di questo ponte.',
  ...
  es:{
    ...
    back:'← ATRÁS',menu_lang:'Idioma: Español 🇪🇸',menu_map:'Mapa & Ubicación',menu_defter:'Puente del Corazón',
    loc_searching:'📍 Obteniendo ubicación…',loc_outside:'📍 Estás fuera del área del Külliye.',
    loc_error:'📍 No se pudo obtener la ubicación. Activa los permisos de ubicación.',
    gb_name:'Nombre y Apellido',gb_city:'Tu Ciudad',gb_msg:'Deja tus sentimientos aquí…',
    gb_submit:'YO TAMBIÉN PONGO UNA PIEDRA EN EL PUENTE 🪨',gb_submitting:'Sellando…',
    gb_conn_err:'Error de conexión. Inténtalo de nuevo.',gb_no_msg:'Por favor deja un mensaje…',
    confirm_text:'Tus sentimientos han sido sellados en el Puente del Corazón. La huella significativa que dejaste enriquece el patrimonio espiritual de nuestro Külliye…',
    ...
    s0_main:'🏛️ COMPLEJO DE SULTAN BAYEZID II',s0_sub:'MUSEO DE LA SALUD',s0_slogan:'✨ VIAJE DE SANACIÓN — ENTRADA AL MUSEO',
    s1_main:'Entrada al Darüşşifa',s1_sub:'🏛️ PUERTA DE JUSTICIA Y SANACIÓN',s1_slogan:'⚖️ PRIMERA PARADA DE LA SANACIÓN',
    ...
    s3_main:'Gran Hospital (ALA OCTAGONAL)',s3_sub:'🏛️ UMBRAL DEL DARÜŞŞIFA',s3_slogan:'🌊 LA CIMA DONDE EL ALMA SANA',
    s4_main:'Madrasa de Medicina',s4_sub:'🎓 CUNA DE LA CIENCIA',s4_slogan:'📚 LUZ DEL CONOCIMIENTO',
    s5_main:'Gran Patio',s5_sub:'🌿 PLÁTANOS CENTENARIOS',s5_slogan:'🌳 TIEMPO Y PAZ',
    s6_main:'Imareta',s6_sub:'🍲 COMPASIÓN Y ABUNDANCIA',s6_slogan:'🍲 LA COCINA DE YAHYA BABA',
    s7_main:'Preparación para el Ambiente Espiritual',s7_sub:'🕌 ENTRADA A LA MEZQUITA',s7_slogan:'✨ UNA CÚPULA, PAZ INFINITA',
    s8_main:'Viaje Espiritual al Interior de la Mezquita',s8_sub:'🕌 PATIO DE LA MEZQUITA',s8_slogan:'🌌 FINAL BAJO LA CÚPULA',
    s9_main:'Momento de la Despedida',s9_sub:'🌊 INVITACIÓN AL PUENTE DEL CORAZÓN',s9_slogan:'✨ DEJA TAMBIÉN TU HUELLA EN ESTA HISTORIA',
    s10_main:'🖋️ Puente del Corazón',s10_slogan:'"La sanación del pasado se encuentra con las palabras de hoy."',
    nav_back:'← ATRÁS',
    s0_ct1:'👑 HISTORIA',s0_ct2:'🏗️ ARQUITECTURA',s0_ct3:'🎧 GUÍA',s0_ct4:'📵 ATENCIÓN',s0_ct5:'📍 UBICACIÓN',s0_ct6:'🏫 ORIENTACIÓN',
    s0_c1:'Ahora estás en uno de los sitios históricos más fascinantes de Edirne, el Museo de Salud del Complejo de Sultan Bayezid II. Bienvenido a este lugar donde la historia y la sanación se encuentran.',
    s0_c2:'Este conjunto de edificios fue construido por Sultan Bayezid II, hijo de Fatih Sultan Mehmet y octavo sultán otomano, bajo el diseño del arquitecto jefe Hayrettin. Es el complejo otomano mejor conservado hasta la actualidad. En el centro está la mezquita, a la derecha el darüşşifa y la madrasa, a la izquierda el imaret y el kiler, junto a los lados de la mezquita las posadas y detrás el puente sobre el río Tunca.',
    s0_c3:'Para ayudarte a visitar el complejo y el museo de manera más consciente, intentaré guiarte con textos, audio e imágenes.',
    s0_c4:'Por favor, no aparte la atención de su teléfono móvil.',
    s0_c5:'Acabas de pasar por la taquilla y estás en el jardín delantero. Detente frente a la gran fotografía del complejo colgada en la pared de enfrente y observa la ubicación de este conjunto de edificios en la ciudad de Edirne.',
    s0_c6:'Mientras caminas hacia este punto, el edificio a tu derecha es la Madrasa de Medicina del complejo, y el de enfrente es el Darüşşifa, quizás el corazón del complejo y centro del museo.',
    s0_callout:'👣 <strong>Después de visitar la gran fotografía, entren al jardín del Darüşşifa por la puerta inmediatamente a la izquierda.</strong>',
    s0_fwd:'COMIENZA EL VIAJE EN EL TIEMPO →',
    s1_ct1:'🏥 1.ER PATIO DEL DARÜŞŞIFA',s1_ct2:'🌍 IMPORTANCIA HISTÓRICA',s1_ct3:'🛏️ SERVICIOS DEL HOSPITAL',s1_ct4:'🩺 CONSULTAS EXTERNAS',s1_ct5:'🧭 ORIENTACIÓN',s1_ct6:'💧 POZO DE LA LECHE',s1_ct7:'🌿 EL ÁRBOL Y LA HIEDRA',s1_ct8:'🎬 SALA DE PRESENTACIONES',
    s1_c1:'Ahora te encuentras en el primer patio del Darüşşifa de Edirne, uno de los importantes centros de sanación otomanos. Por favor detente un momento y observa lo que te rodea.',
    s1_c2:'Primero debes saber esto: este edificio es considerado uno de los primeros ejemplos de hospitales con planta central y detallada en la historia. En Occidente aparecieron ejemplos similares recién unos 200 años después.',
    s1_c3:'Avanzando por el camino de frente, las cuatro habitaciones inmediatamente a la izquierda de la entrada son los servicios del Darüşşifa: habitación del personal, lavandería, cocina dietética y despensa.',
    s1_c4:'A tu derecha, detrás de las columnas, hay seis consultorios externos donde se realizaban las visitas diarias, cuidados e intervenciones de urgencia.',
    s1_c5:'Deja la visita detallada de estas habitaciones para el regreso y ahora dirígete a la sala de presentaciones, ubicada más adelante a la izquierda.',
    s1_c6:'Esta estructura de piedra se llama "Pozo de la Leche" porque se creía que su agua aumentaba la leche de las madres recientes.',
    s1_c7:'Unos 20 metros más adelante, entre la hierba, verás un árbol con hiedra enredada. Lee el triste poema de amor de Ahmet Kutsi Tecer en ese panel.',
    s1_c8:'Inmediatamente a la izquierda del poema está la sala de presentaciones, donde puedes ver el video sobre la historia del complejo y el Darüşşifa.',
    s1_callout:'🎬 <strong>¿Quieres ver la presentación en vídeo? Puedes verla dentro de la sala o en tu teléfono.</strong>',
    s1_watch:'VER LA PRESENTACIÓN ▶',s1_fwd:'PASO AL 2.º PATIO →',
    s2_ct1:'🚪 ENTRADA AL 2.º PATIO',s2_ct2:'🏛️ OFICINAS ADMINISTRATIVAS',s2_ct3:'🔒 SECCIÓN ADMINISTRATIVA',s2_ct4:'✨ INSCRIPCIÓN Y ENTRADA',
    s2_c1:'Nada más salir de la sala de presentaciones, pasa por la majestuosa puerta inmediatamente a la izquierda y entra al segundo patio con las oficinas de los directivos.',
    s2_c2:'En este patio hay 4 habitaciones, dos a cada lado. El médico jefe y los demás médicos usaban estas habitaciones; todas las actividades del hospital se planificaban y ejecutaban aquí.',
    s2_c3:'Esta sección con las oficinas administrativas también servía como barrera protectora entre la circulación diaria de pacientes en el primer patio y el pabellón de hospitalización al que estás a punto de entrar.',
    s2_c4:'Ahora lee la inscripción del hospital escrita sobre la puerta… y contén la respiración…',
    s2_callout:'🚶‍♂️ <strong>Entra en este lugar mágico donde la música y el sonido del agua se encuentran con la sanación.</strong>',
    s2_fwd:'DESCUBRE EL GRAN HOSPITAL →',
    s3_ct1:'🏥 PABELLÓN DE HOSPITALIZACIÓN',s3_ct2:'🌊 ESTRUCTURA DEL HOSPITAL',s3_ct3:'🎵 MUSICOTERAPIA',s3_ct4:'💧 HIDROTERAPIA',s3_ct5:'🌿 AROMATERAPIA',s3_ct6:'🧺 TERAPIA OCUPACIONAL',s3_ct7:'🚶 SALIDA Y VISITA',
    s3_c1:'Ahora te encuentras en el corazón del museo y en el pabellón de hospitalización del Darüşşifa de Edirne. Camina con los sentimientos de quienes encontraron sanación en este lugar de cura hace 500 años.',
    s3_c2:'Imagina un hospital donde en el centro fluye una fuente con ritmo constante y frente hay un escenario musical. Este hospital de planta central cubierto por una gran cúpula se compone de 6 habitaciones de invierno, 4 de verano y un escenario musical.',
    s3_c3:'La característica principal que distinguía a este hospital de los demás era el uso de los maqam musicales en el tratamiento. Un grupo de 10 músicos interpretaba música según las indicaciones de los médicos para cada enfermedad.',
    s3_c4:'El sonido del agua que fluía desde la fuente en el centro del edificio era una parte importante de la terapia, destinada a tranquilizar a los pacientes.',
    s3_c5:'Además de la música y el sonido del agua, también se practicaba aromaterapia. Los perfumes de las plantas cultivadas en el patio del Darüşşifa eran una parte importante de la cura.',
    s3_c6:'La terapia ocupacional también se usaba como tratamiento en este hospital. Los pacientes eran ocupados en tejido de canastas, punto y varios trabajos manuales para distraerlos de sus preocupaciones.',
    s3_c7:'Después de visitar las habitaciones que ilustran los distintos aspectos de la medicina otomana, puedes salir del pabellón de hospitalización.',
    s3_callout:'🏫 <strong>Hacia la Madrasa de Medicina: sal del Darüşşifa y dirígete a la Madrasa de Medicina en el lado izquierdo del jardín de entrada.</strong>',
    s3_fwd:'CAMINO HACIA LA MADRASA →',
    s4_ct1:'🏫 MADRASA DE MEDICINA',s4_ct2:'🌍 IMPORTANCIA HISTÓRICA',s4_ct3:'📚 SISTEMA EDUCATIVO',s4_ct4:'🏛️ ESTRUCTURA ARQUITECTÓNICA',s4_ct5:'📜 EVLIYA ÇELEBI',s4_ct6:'👨‍🏫 CUERPO DOCENTE',s4_ct7:'📖 MANUSCRITOS',s4_ct8:'🏥 MUSEO DE SALUD',
    s4_c1:'Tras visitar el Darüşşifa, hemos llegado a la otra sección importante del complejo, la Madrasa de Medicina del Complejo de Sultan Bayezid II.',
    s4_c2:'El edificio que rodea el patio cuadrado que estás viendo era una de las instituciones educativas más prestigiosas del Imperio Otomano para la formación de médicos.',
    s4_c3:'Como madrasa del grado más alto en el sistema educativo otomano, los estudiantes podían profundizar la formación teórica a través de la práctica en el Darüşşifa adyacente.',
    s4_c4:'Esta madrasa está compuesta por 18 habitaciones para estudiantes en tres lados y un aula frontal.',
    s4_c5:'Evliya Çelebi, que visitó el complejo en 1652, escribió: "En la madrasa de medicina hay estudiantes que discuten constantemente sobre estudiosos como Platón, Sócrates, Aristóteles y Galeno."',
    s4_c6:'El cuerpo docente estaba compuesto por un profesor que enseñaba a 18 estudiantes con un salario diario de 60 akçe, un asistente, un bibliotecario y 2 sirvientes.',
    s4_c7:'38 manuscritos médicos escritos a mano aquí han sobrevivido hasta hoy y actualmente se conservan en la Biblioteca de Manuscritos de Selimiye.',
    s4_c8:'La madrasa fue inaugurada como segunda sección del museo de salud por la Universidad de Tracia en 2007. El aula frontal en la entrada es la parte más importante.',
    s4_callout:'🚶 <strong>Después de visitar las habitaciones, salid de la madrasa, pasad por el torniquete y dirigíos al patio de la mezquita.</strong>',
    s4_fwd:'HACIA LA MAJESTUOSIDAD DE LA MEZQUITA →',
    s5_ct1:'🌳 EN EL JARDÍN',s5_ct2:'💧 BALANZA DEL AGUA',s5_ct3:'🕌 PORTAL PRINCIPAL MEZQUITA',s5_ct4:'🏛️ KILER E IMARET',
    s5_c1:'Tras visitar el Darüşşifa y la madrasa, has entrado en el jardín de la mezquita. Camina lentamente por este hermoso jardín alineado con plátanos centenarios y dirígete hacia la sección del imaret al frente.',
    s5_c2:'Al entrar al jardín por el lado del Darüşşifa, en la esquina de la mezquita a la derecha encontrarás una estructura rectangular de piedra de unos 4 metros de altura. Esta es la balanza del agua del complejo.',
    s5_c3:'Pasada la balanza del agua, el majestuoso portal de la mezquita te recibe a la derecha. Dejemos la exploración por ese portal para el final del recorrido.',
    s5_c4:'Al frente hay dos grandes edificios con arquitectura similar. El de la izquierda es el kiler y el horno, el de la derecha es el imaret que visitaremos ahora.',
    s5_callout:'🍲 <strong>¿Estás listo para escuchar la cultura del imaret otomano y la leyenda de Yahya Baba?</strong>',
    s5_fwd:'HACIA EL CENTRO DE LA ABUNDANCIA →',
    s6_ct1:'🏛️ IMARETES',s6_ct2:'🍲 IMARET DE SULTAN BAYEZID II',s6_ct3:'🔥 COCINA Y COMEDOR',s6_ct4:'🎭 ESTA SECCIÓN DEL MUSEO',s6_ct5:'🌿 MAUSOLEO DE YAHYA BABA',s6_ct6:'📖 LEYENDA DE YAHYA BABA',s6_ct7:'⚖️ PRUEBA DEL DESPENSERO',s6_ct8:'👑 TESTIMONIO DEL SULTÁN',s6_ct9:'🐟 EL MILAGRO DE LOS PECES',s6_ct10:'🤲 EL FINAL DE YAHYA BABA',s6_ct11:'🪦 VISITA AL MAUSOLEO',
    s6_c1:'En el Imperio Otomano, los imaretes eran una de las instituciones más importantes que encarnaban el espíritu de solidaridad social y compasión. Distribuían comidas gratuitas a pobres, viajeros y estudiantes.',
    s6_c2:'Te encuentras precisamente en uno de esos lugares. El Imaret del Complejo de Sultan Bayezid II está abierto como tercera sección del museo de salud.',
    s6_c3:'El amplio espacio que ves en la entrada es la cocina. La gran sala visible por la puerta de la derecha era el lugar donde se comía en mesas de piedra en el suelo.',
    s6_c4:'Esta sección también está animada con maniquíes de tamaño real que narran la cultura de los imaretes otomanos.',
    s6_c5:'Justo detrás del imaret se encuentra el mausoleo del legendario Yahya Baba. Te cuento la leyenda transmitida hasta hoy.',
    s6_c6:'Según la leyenda, Yahya Baba era el cocinero jefe durante el reinado de Sultan Bayezid II y preparaba un pilaf de arroz exquisito. Iba a darle el pilaf sobrante a los peces del río Tunca.',
    s6_c7:'El despensero, al verlo, comenzó a reducir la cantidad de arroz que recibía cada día. Aun así Yahya Baba continuaba cocinando el pilaf rezando, alimentando a pacientes y peces.',
    s6_c8:'El rumor llegó a oídos del Sultán, quien se escondió en la orilla del río para presenciarlo en persona. "¡Oye, estás tirando la comida de los pacientes al río!" gritó enfadado.',
    s6_c9:'Mientras Yahya Baba se paralizaba y se postraba, los peces levantaron la cabeza del agua y hablaron: "¿El gran Sultán envidia la comida de los peces?"',
    s6_c10:'El Sultán comprendió su error y esperó a que Yahya Baba se levantara… pero este hombre virtuoso ya había partido de esta vida.',
    s6_c11:'El mausoleo de Yahya Baba sigue siendo venerado hoy como lugar sagrado visitado por quienes pasan para rezar.',
    s6_callout:'🪦 <strong>Tras escuchar esta leyenda, sal del imaret y descansa en el bar del museo a la izquierda.</strong>',
    s6_fwd:'HACIA EL BAR DEL MUSEO →',
    s7_ct1:'🏛️ PATIO Y ENTRADA MEZQUITA',s7_ct2:'🚪 ENTRADA Y ATMÓSFERA',s7_ct3:'⛲ FUENTE Y QUIETUD',s7_ct4:'🏛️ COLUMNAS DE MÁRMOL',s7_ct5:'✨ PAZ INTERIOR',s7_ct6:'👁️ MOMENTOS DE OBSERVACIÓN',s7_ct7:'🚪 ENTRADA A LA MEZQUITA',s7_ct8:'🪵 ARTE KÜNDEKARI',
    s7_c1:'Tras visitar las secciones del museo de salud y tomar un sorbete en el bar, es el momento de encontrarse con el edificio más majestuoso del complejo: la mezquita.',
    s7_c2:'Al entrar por la puerta que da al patio, serás recibido por el arte de la talla en mármol. Deja el ruido del mundo exterior y entra en una atmósfera completamente diferente.',
    s7_c3:'La fuente en el centro del patio llena el espacio con un sonido de agua tranquilo, trayendo paz.',
    s7_c4:'Las columnas de mármol que rodean se elevan como un anillo protector.',
    s7_c5:'Lo que se siente aquí no es solo la belleza de la arquitectura. Es la paz interior que no ha cambiado durante siglos.',
    s7_c6:'Detente un momento junto a la fuente y observa la armonía de este patio.',
    s7_c7:'Luego vuélvete hacia el majestuoso portal de enfrente y empuja suavemente la cortina de cuero que cubre la puerta para entrar.',
    s7_c8:'En la entrada, observa la talla de madera kündekari original encima de la puerta.',
    s7_callout:'🕌 <strong>¿Entramos al interior del santuario?</strong>',
    s7_fwd:'AVANZA HACIA EL INTERIOR →',
    s8_ct1:'🕌 INTERIOR MEZQUITA — FINAL',s8_ct2:'🚤 TRANSPORTE HISTÓRICO Y TRADICIÓN REAL',s8_ct3:'👑 IMAGINAR LA TRIBUNA REAL',s8_ct4:'🏛️ TRIBUNA REAL',s8_ct5:'⚙️ MIHRAB Y PIEDRAS DE EQUILIBRIO',s8_ct6:'🪵 MIMBAR Y ARTESANÍA',s8_ct7:'📐 SÍMBOLOS Y SIGNIFICADOS',s8_ct8:'💡 LUZ Y ACÚSTICA',s8_ct9:'🌌 LA MAJESTUOSIDAD BAJO LA CÚPULA',s8_ct10:'🏗️ PUNTO DE INFLEXIÓN ARQUITECTÓNICO',s8_ct11:'✨ FINAL Y DESPEDIDA',
    s8_c1:'Ahora te encuentras en el interior de la mezquita, el centro del complejo. Concluimos el recorrido bajo esta majestuosa cúpula.',
    s8_c2:'Sultan Bayezid II y los sultanes posteriores venían a esta mezquita cruzando el río Tunca en una barca real. Entraban por la puerta en la orilla del río y rezaban en la tribuna real.',
    s8_c3:'Cierra los ojos… imagina al Sultán rezando en esa altura en la misma paz que todos los demás.',
    s8_c4:'Aquí se encuentra la primera tribuna real jamás construida en la historia de la arquitectura islamo-turca. Dirijámonos ahora al mihrab.',
    s8_c5:'Toca las piedras de equilibrio a ambos lados del mihrab y gíralas ligeramente: te sorprenderá que los cimientos de este gran edificio no estén inclinados ni un milímetro.',
    s8_c6:'Acercándote al púlpito a la derecha, quedarás asombrado por la delicadeza y elegancia de la talla en mármol.',
    s8_c7:'Da la espalda al mihrab y mira sobre la puerta de entrada. El motivo de la sandía simboliza que hay un imaret en el complejo y que los visitantes están invitados a comer.',
    s8_c8:'Las ventanas alrededor de la cúpula garantizan una luz uniforme en todo el espacio. Combinada con la poderosa acústica de la mezquita, otorga profundidad al espacio.',
    s8_c9:'Y ahora levanta la mirada… contempla esta majestuosa cúpula de unos 31 metros de altura y 22 metros de diámetro. Una obra maestra arquitectónica sostenida por cuatro paredes sin columnas intermedias.',
    s8_c10:'También se considera un importante precursor en la transición hacia las estructuras de cúpula única.',
    s8_c11:'Bajo esta cúpula incomparable, concluimos este viaje que ha conectado las huellas del pasado con la quietud de hoy. Lleva contigo la paz y el asombro que este lugar ha dejado en tu corazón.',
    s8_callout:'🙏 <strong>¿Decimos un silencioso adiós a este viaje espiritual?</strong>',
    s8_fwd:'HACIA LA DESPEDIDA →',
    s9_c1:'🏛️ Paso a paso seguimos las huellas del pasado y dimos vida a esta magnífica arquitectura. Ahora es el momento de añadir tu propio aliento a este lugar histórico.',
    s9_c2:'💭 Lo que resuena en tu corazón… un momento de paz, una profunda admiración, o una nota silenciosa que permanece en tu mente…',
    s9_c3:'📖 El libro de visitas preparado para ti es el archivo espiritual de esta experiencia.',
    s9_c4:'✨ Comparte con nosotros lo que desborda de tu corazón y deja una huella eterna en el Puente del Corazón…',
    s9_callout:'✍️ <strong>Te invitamos a escribir tus sentimientos en la página del Puente del Corazón.</strong>',
    s9_fwd:'ESCRIBE EN EL PUENTE DEL CORAZÓN →',
    s10_body:'Cuéntanos la impresión que este viaje de 500 años ha dejado en el complejo. Tus palabras se convierten en las piedras de este puente.',
...
const STOP_NAMES_I18N = {
  ...
  it:['Ingresso Museo','Darüşşifa 1° Cortile','Darüşşifa 2° Cortile','Ospedale','Madrasa di Medicina','Grande Cortile','Imaretto','Cortile Moschea','Interno Moschea','Invito al Ponte del Cuore','Ponte del Cuore'],
  es:['Entrada Museo','Darüşşifa 1.er Patio','Darüşşifa 2.º Patio','Hospital','Madrasa de Medicina','Gran Patio','Imareta','Patio Mezquita','Interior Mezquita','Invitación al Puente del Corazón','Puente del Corazón']
};
...
const MENU_MAP_I18N = {
  ...
  it:'Mappa & Posizione',es:'Mapa & Ubicación'
};
...
const MENU_DEFTER_I18N = {
  ...
  ro:'Podul Inimii',ja:'心の橋',it:'Ponte del Cuore',es:'Puente del Corazón'
};
...
const LANG_CLOSE_I18N = {
  ...
  ro:'ÎNCHIDE',ja:'閉じる',it:'CHIUDI',es:'CERRAR'
};
...
function speakText(text){
  ...
  u.lang=currentLang==='en'?'en-US':currentLang==='de'?'de-DE':currentLang==='fr'?'fr-FR':currentLang==='el'?'el-GR':currentLang==='zh'?'zh-CN':currentLang==='fa'?'fa-IR':currentLang==='it'?'it-IT':currentLang==='es'?'es-ES':'tr-TR';
